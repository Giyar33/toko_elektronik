...
<div class="container">
        <div class="card-checkout" style="margin-top: 50px">
            <form action="" method="POST">
                ...
                <input type="text" name="harga_produk" class="form-control" value="<?= number_format($data['harga_produk']); ?>" disabled ><br /><br />

                <label>Sub Total Harga</label>
                <input type="text" name="subtotal" class="form-control"
                    value="<?= $totalHarga =  $result * $data["harga_produk"]; ?>" disabled ><br /><br />
